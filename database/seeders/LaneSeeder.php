...
class LaneSeeder extends Seeder
{
    public function run()
    {
        ...
        Lane::create(['number' => 1, 'has_fence' => false]);
        Lane::create(['number' => 2, 'has_fence' => false]);
        Lane::create(['number' => 3, 'has_fence' => false]);
        Lane::create(['number' => 4, 'has_fence' => false]);
        Lane::create(['number' => 5, 'has_fence' => false]);
        Lane::create(['number' => 6, 'has_fence' => false]);
        

        // Lanes without safety fences (e.g., lane 8)
        Lane::create(['number' => 7, 'has_fence' => true]);
        Lane::create(['number' => 8, 'has_fence' => true]);
