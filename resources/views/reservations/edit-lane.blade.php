...
<form action="{{ route('reservations.update.lane', $reservation->id) }}" method="POST" class="max-w-lg mx-auto p-6 bg-white rounded-lg shadow-lg">
    ...
    <!-- Back Button -->
    <div class="mb-4">
        <a href="/reservations" class="text-blue-500 hover:text-blue-700 font-medium text-lg">&larr; Terug</a>
    </div>

    <!-- Form Fields for Lane Number -->
    <div class="mb-6">
        <label for="lane_number" class="block text-xl font-semibold text-gray-700 mb-2">Selecteer Baan</label>
