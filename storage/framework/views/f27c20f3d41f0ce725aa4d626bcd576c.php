            ...
            <div class="overflow-x-auto">
                <table class="min-w-full bg-white border border-gray-200 rounded-lg shadow-xl">
                    ...
                    <?php $__currentLoopData = $reservations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reservation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="text-gray-600 reservation-row" data-reservation-date="<?php echo e($reservation->date); ?>">
                            <td class="py-2 px-4 border-b"><?php echo e($reservation->person ? $reservation->person->first_name . ' ' . $reservation->person->last_name : 'No Name Found'); ?></td>
                            <td class="py-2 px-4 border-b"><?php echo e(\Carbon\Carbon::parse($reservation->date)->format('l, F j, Y')); ?></td>
                            <td class="py-2 px-4 border-b"><?php echo e($reservation->lane ? $reservation->lane->number : 'No Lane Assigned'); ?></td>
                            <td class="py-2 px-4 border-b"><?php echo e($reservation->packageOption ? $reservation->packageOption->name : 'None'); ?></td>
                            <td class="py-2 px-4 border-b"><?php echo e(\Carbon\Carbon::parse($reservation->start_time)->format('H:i')); ?></td>
                            <td class="py-2 px-4 border-b"><?php echo e(\Carbon\Carbon::parse($reservation->end_time)->format('H:i')); ?></td>
                            <td class="py-2 px-4 border-b"><?php echo e(\Carbon\Carbon::parse($reservation->start_time)->diffInHours(\Carbon\Carbon::parse($reservation->end_time))); ?> hours</td>
                            <td class="py-2 px-4 border-b"><?php echo e($reservation->adult_count); ?></td>
                            <td class="py-2 px-4 border-b"><?php echo e($reservation->child_count); ?></td>
                            <td class="py-2 px-4 border-b">
                                <a href="<?php echo e(route('reservations.edit-lane', $reservation->id)); ?>" class="text-blue-500 hover:text-blue-700">Edit Lane</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\dag03\resources\views/reservations/index.blade.php ENDPATH**/ ?>